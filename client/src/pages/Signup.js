...
import p1 from "../css/img/avtoriz2.jpg"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-field">
                                                <button class="main-btn" type="submit">Регистрация <i class="far fa-arrow-right"></i></button>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <p >
                                                Есть профиль?
                                                <Link to="/login" className='mt-3'>Войти</Link>
                                            </p>
                                        </div>
